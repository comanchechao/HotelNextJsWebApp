  ...
  return (
    <div className="w-full h-full p-3">
      <div className="w-full h-auto flex-col flex items-end justify-end bg-white drop-shadow-md">
        ...
        <div className="w-full h-36 border-t border-darkPurple border-dashed p-6 justify-end flex items-center">
          <div className="flex flex-col items-end justify-end space-y-2 text-right">
